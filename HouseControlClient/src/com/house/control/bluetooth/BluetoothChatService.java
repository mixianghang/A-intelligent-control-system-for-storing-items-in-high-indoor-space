...
public class BluetoothChatService {
    ...
    private int mState;
    public  static BluetoothChatService service=null;
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BlueToothActivity.MESSAGE_STATE_CHANGE, state, mState).sendToTarget();
        mState = state;
    }
    ...
    public void write(byte[] out) {
        ...
        Log.e("client send", new String(out));
        r.write(out);
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                // 将发送给对方的信息同时显示在本方聊天框中，Share the sent message back to the UI Activity
